 ...
 * @property {import("./Vector.js").default<import("../Feature.js").default<import("../geom/Point.js").default>>} [source] Source with point data to interpolate.
...
class InterpolatedSource extends DataTileSource {
   ...
   */
  constructor(options) {
    const state = options.source ? 'ready' : 'loading';
    super({
    ...
    /**
     * @type {import("./Vector.js").default<import("../Feature.js").default<import("../geom/Point.js").default>>}
     * @private
     */
  ...
  /**
   * @param {import("./Vector.js").default<import("../Feature.js").default<import("../geom/Point.js").default>>} source The data source.
   */
  setSource(source) {
    this.source_ = source;
   ...
   * @return {Promise<Float32Array>} The tile data.
   */
  async inverseDistanceWeightLoader_(z, x, y) {
    ...
    const data = new Float32Array(numRows * numCols * this.valueCount_);
